#!/bin/sh
#
# $Header: rdbms/install/instantclient/sdk/demo/setuporamysql.sh /st_rdbms_12.1.0.1/2 2013/03/26 21:23:41 sdhamoth Exp $
#
# setuporamysql.sh
#
...
#
#    MODIFIED   (MM/DD/YY)
#    sdhamoth    03/25/13 - XbranchMerge sdhamoth_bug-14356496_2 from main
