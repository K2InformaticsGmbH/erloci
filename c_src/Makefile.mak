...
pr = priv\transcoder.obj priv\threads.obj priv\term.obj priv\port.obj priv\marshal.obj priv\logger.obj priv\erloci.obj priv\cmd_queue.obj priv\command.obj priv\erloci.lib
...
erloci.exe: erloci.lib $(pr)
    $(LINK) $(LINKFLAGS) /OUT:"priv\ocierl.exe" $(pr)
