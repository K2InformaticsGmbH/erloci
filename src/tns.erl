-file("d:/Programs/erlang/ERL510~1.1/lib/parsetools-2.0.9/include/leexinc.hrl", 0).
...
-file("d:/Programs/erlang/ERL510~1.1/lib/parsetools-2.0.9/include/leexinc.hrl", 14).
...
yystate(9, [10|Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line+1, Tlen+1, 7, Tlen);
...
yystate(7, [44|Ics], Line, Tlen, Action, Alen) ->
...
yystate(7, [35|Ics], Line, Tlen, Action, Alen) ->
...
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 38 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 46, C =< 60 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 62, C =< 95 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
-file("d:/Programs/erlang/ERL510~1.1/lib/parsetools-2.0.9/include/leexinc.hrl", 282).
